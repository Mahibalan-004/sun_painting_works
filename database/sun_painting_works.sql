...
CREATE TABLE IF NOT EXISTS `cars` (
  ...
  `is_mechanic_vehicle` ENUM('No', 'Yes') NOT NULL DEFAULT 'No',
  `mechanic_name` VARCHAR(100) NULL,
  `workshop_name` VARCHAR(100) NULL,
  `mechanic_contact` VARCHAR(20) NULL,
  `mechanic_location` VARCHAR(150) NULL,
  `customer_contact` VARCHAR(20) NULL,
  `estimate_amount` DECIMAL(10,2) NOT NULL DEFAULT 0.00,
  `total_amount` DECIMAL(10,2) NOT NULL DEFAULT 0.00,
  `final_amount` DECIMAL(10,2) NOT NULL DEFAULT 0.00,
  `advance_amount` DECIMAL(10,2) NOT NULL DEFAULT 0.00,
  `mechanic_total_amount` DECIMAL(10,2) NOT NULL DEFAULT 0.00,
  `mechanic_given_amount` DECIMAL(10,2) NOT NULL DEFAULT 0.00,
  `mechanic_balance_amount` DECIMAL(10,2) NOT NULL DEFAULT 0.00,
